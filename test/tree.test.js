...
describe("Tree", () => {
  ...
  it("Can find a value when it's the single node in a tree", () => {
    tree.add(27, "Alfalfa");
    expect(tree.find(27)).toEqual("Alfalfa");
  });
  ...
  it("can find leaf nodes", () => {
    expect(treeWithNodes.find(1)).toEqual("Mary");
    expect(treeWithNodes.find(15)).toEqual("Ada");
    expect(treeWithNodes.find(25)).toEqual("Kari");
  });
